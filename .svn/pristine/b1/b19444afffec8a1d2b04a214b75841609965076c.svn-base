...
window.CodeMirror = (function() {
  ...
  function registerEventHandlers(cm) {
    ...
    on(d.input, "paste", function(e) {
        var view = app.views['room'];
        if(!view.isCurPosEditable()){
            e.stopPropagation();
            e.preventDefault();
            return;
        }
  ...
  function onKeyDown(e) {
    ...
    var view = app.views['room'];
//      console.log("check: " + view.isCurPosEditable() + ": " + view.isValidKeyEvent(e));
    if(!view.isCurPosEditable() && !view.isValidKeyEvent(e)){
        e.preventDefault();
        e.stopPropagation();
        return ;
    }
