...
(function () {
    ...
    app.FileView = Backbone.View.extend({
        ...
        events: {
            ...
            'click a.file-go-transfer': 'transfer'
        },
        ...
        transfer: function () {
//            app.collections['transfer'].set(this.model.get('path'));
//            console.log(this.model.get('path'));
//            console.log(app.collections['transfer']);
            app.collections['transfer'].path = this.model.get('path');
            $('#transfer').modal('show');
        },
