...
//        CodeMirror.on(editor.getDoc(), 'beforeChange', function(editorDoc, chg){
//            if (chg.text.length > 1) {
////                if(editor.getTheme() == 'comment-mode') {
//                    var startLine = chg.from.line;
//                    var line = editor.getLine(startLine);
//                    var indent = Array(editor.getOption("indentUnit") + 1).join(" ");
//                    if(editor.getLineHandle(startLine).bgClass == "comment") {
//                        if (chg.text[0] == "" && chg.text[1] == "") {
////                            cm.replaceRange("*",
////                                {line: startLine + 1, ch: line.length});
//                             chg.update(chg.from, chg.to, ["", indent + "* "]);
//                        }
//                    }
////                }
//            }
...
//        if (chg.text.length > 1) {
//            room.view.refreshCommentArea(chg);
//        }
            room.view.updateCommentArea(chg);
